...
class _$LocationModelImpl extends _LocationModel {
  const _$LocationModelImpl(
      ...
      @JsonKey(name: 'radius_meters') this.radiusMeters = 50,
  ...
  @override
  String toString() {
    return 'LocationModel(id: $id, name: $name, address: $address, latitude: $latitude, longitude: $longitude, radiusMeters: $radiusMeters, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, address, latitude,
      longitude, radiusMeters, createdAt, updatedAt);
